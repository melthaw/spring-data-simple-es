...
import in.clouthink.daas.es.test.request.DefaultHttpRequestEventSearchRequest;
...
public class HttpRequestEventRepositoryTest extends AbstractTest {
    ...
    @Test
    public void testCreateHttpRequestEvent() throws Exception {
        for (int i = 0; i < 100; i++) {
            HttpRequestEvent newData = new HttpRequestEvent();
            newData.setRealm("daas-es");
        ...
        Assert.assertTrue(eventPage.getTotalElements() >= 100);
    }
